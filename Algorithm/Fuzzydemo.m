...
data = load('E:\Tools\dataprocessing\ORL32x32_outlier_nosiy.mat','X');
label = load('E:\Tools\dataprocessing\ORL32x32_outlier_nosiy.mat','Y');
...
workbook = excel.Workbooks.Open('E:\RFKM\result\FuzzyCmeans_result_outliernoise.xlsx');
